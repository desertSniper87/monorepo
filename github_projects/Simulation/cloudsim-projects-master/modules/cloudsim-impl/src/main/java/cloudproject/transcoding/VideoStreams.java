...
public class VideoStreams implements Callable<String>{
	...
	//Every instance has its own lstCloudlet
    ...
    public String call() {
     ...
     private void processCommand() {
		...
		//File folder = new File("Users/Torsho/Dropbox/Programming Code/Github projects/Simulation/cloudsim-projects-master/modules/cloudsim-impl/inputdatafile");
		...
		if(fileIndex < listOfFiles.length){
			...
			// lstCloudlet.clear();
			 ...
			 System.out.println(Thread.currentThread().getName() +" Video Stream_"+ command + ": Created " + cloudletList.size() + " Cloudlets\n"); 
				// cloudletBatchQueue.addAll(lstCloudlet);
