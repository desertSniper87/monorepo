 ...
 */
public class CloudSimExample6graphCreator extends ApplicationFrame {

    private static XYSeriesCollection dataSetCloudletVsCloudletID;
    private static XYSeries seriesVMVsExecutionTime = new XYSeries("SJF");

    private static List<Cloudlet> receivedCloudletList;
    private static List<Double> finishTimeList;

    public CloudSimExample6graphCreator(String title) {
        super(title);
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            for (int i = 4; i < 35; i++) {
                ...
                CloudSimExample6vanilla cloudSimulator = new CloudSimExample6vanilla();
                ...
                try(FileWriter fw = new FileWriter("Vm VS finishTime SJF", true);
            ...
            CloudSimExample6graphCreator chart = new CloudSimExample6graphCreator("Finishing time vs. number of VMs");
            chart.pack();
