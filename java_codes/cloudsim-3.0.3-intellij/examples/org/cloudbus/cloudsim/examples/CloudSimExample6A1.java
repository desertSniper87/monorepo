 ...
 */
public class CloudSimExample6A1 extends ApplicationFrame{
    ...
    public CloudSimExample6A1(String title) {
        super(title);
...
//			vm[i] = Vm(i, userId, mips, pesNumber, ram, bw, size, priority, vmm, new CloudletSchedulerSpaceShared());
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            DatacenterBrokerA1 broker = createBroker();
            ...
            CloudSimExample6A1 chart = new CloudSimExample6A1("Execution time vs Cloudlets");
            chart.pack();
    ...
    private static DatacenterBrokerA1 createBroker(){
        ...
        DatacenterBrokerA1 broker = null;
        try {
    ...
    private static void printCloudletList(List<Cloudlet> list) {
        int size = list.size();
        Cloudlet cloudlet;
        seriesCloudletVsCloudletID = new XYSeries("A1");
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (cloudlet.getCloudletStatus() == Cloudlet.SUCCESS){
                ...
                seriesCloudletVsCloudletID.add(i, cloudlet.getActualCPUTime() );

//                try(FileWriter fw = new FileWriter("cloudletData/Vm VS finishtime 4VM500C A1.dat", true);
