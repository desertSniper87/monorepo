 ...
 */
public class CloudSimExample6A2graphCreator extends ApplicationFrame {

    private static XYSeriesCollection dataSetCloudletVsCloudletID;
    private static XYSeries seriesVMVsExecutionTime = new XYSeries("A2");

    private static List<Cloudlet> receivedCloudletList;
    private static List<Double> finishTimeList;

    public CloudSimExample6A2graphCreator(String title) {
        super(title);
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            for (int i = 4; i < 35; i++) {
                ...
                CloudSimExample6A2vanilla cloudSimulator = new CloudSimExample6A2vanilla();
                ...
                try(FileWriter fw = new FileWriter("Vm VS finishTime A2 Mod", true);
            ...
            CloudSimExample6A2graphCreator chart = new CloudSimExample6A2graphCreator("Finishing time vs. number of VMs");
            chart.pack();
