...
public class Main
{
	...
	{
		new Main(); // I like doing things this way so I don't have to use static objects
	}
	...
	void setupGraph()
	{
		...
		*/
		...
		G[0][1]=true; // notice that for each edge G[i][j] == G[j][i]
		G[1][2]=true;	// this means that the graph is undirected
	}
