...
class User(AbstractUser):          #APPLICANT IN USER
    ...
    name = models.CharField(_('Name of User'), blank=False, max_length=50)
    gender = models.CharField(_('Gender'), blank=False, max_length=1, default='M')
    present_address = models.CharField(_('Present Address'), blank=True, max_length=80)
    permanent_address = models.CharField(_('Present Address'), blank=True, max_length=80)
    father_name = models.CharField(_('Father\'s name of User'), blank=True, max_length=50)
    mother_name = models.CharField(_('Mother\'s name of User'), blank=True, max_length=50)
