...
void insertNodeAtHead(SinglyLinkedListNode* llist, int data) {
    llist->data = data;
    llist->next = (SinglyLinkedListNode*) malloc(sizeof(SinglyLinkedListNode));
}
...
SinglyLinkedListNode* insertNodeAtPosition(SinglyLinkedListNode* head, int data, int position) {
    ...
    SinglyLinkedListNode* old = head->next;
    head->next = temp;
    temp->next = old;
