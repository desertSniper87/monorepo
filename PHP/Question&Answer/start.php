  ...
  <div class="modal-dialog">
    <div class="modal-content title1">
      ...
      <div class="modal-body">
        <form class="form-horizontal" action="login.php?q=start.php" method="POST">
<fieldset>
...
<div class="col-md-2 box">
<a href="about.php" s style="color:lightyellow;" onmouseover="this.style('color:yellow')" target="new">About Quiz</a></div>
</div>
...
<div class="col-md-6">
<form role="form" method="post" action="admin.php?q=start.php">
<div class="form-group">
