...
<h2 align="center" style="font-family:'typo'; color:#000066">About Quiz</h2>
...
<div class="col-md-2 box">
<span href="about.php" s style="color:lightyellow;text-decoration:underline" onmouseover="this.style('color:yellow')">About Quiz</span></div>
</div>
</body>
</html>
